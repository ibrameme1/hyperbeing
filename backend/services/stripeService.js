...
export const PLANS = {
  free:  { name: 'Free',  price: 0,   credits: 150,  tokenLimit:  500_000, priceId: null,                                 annualPriceId: null },
...
export function getOrCreateSubscription(userId) {
  ...
  if (!sub) {
    ...
    ).run(id, userId, admin ? 'ultra' : 'free', 'active', admin ? 999999 : PLANS.free.credits, admin ? 999999 : PLANS.free.credits);
